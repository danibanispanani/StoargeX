...
export const PRODUCT_TABLE_DEFINITION = {
  ...
  columns: [
    ...
    { key: "condition", label: "Zustand", defaultVisible: false, sortable: false },
    { key: "ebayCategory", label: "eBay-Kategorie", defaultVisible: false, sortable: false },
    { key: "ebayBreakEven", label: "eBay-Mindestpreis", defaultVisible: false, sortable: false },
    { key: "ebayProfit", label: "eBay-Gewinn", defaultVisible: false, sortable: false },
    { key: "kauflandCategory", label: "Kaufland-Kategorie", defaultVisible: false, sortable: false },
    { key: "kauflandBreakEven", label: "Kaufland-Mindestpreis", defaultVisible: false, sortable: false },
    { key: "kauflandProfit", label: "Kaufland-Gewinn", defaultVisible: false, sortable: false },
    { key: "calculationStatus", label: "Kalkulationsstatus", defaultVisible: false, sortable: false },
  ],
  presets: [
